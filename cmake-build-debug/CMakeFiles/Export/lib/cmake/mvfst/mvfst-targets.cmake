...
foreach(_expectedTarget mvfst::mvfst_constants mvfst::mvfst_exception mvfst::mvfst_transport mvfst::mvfst_client mvfst::mvfst_codec_types mvfst::mvfst_codec_decode mvfst::mvfst_codec_pktbuilder mvfst::mvfst_codec_pktrebuilder mvfst::mvfst_codec_packet_number_cipher mvfst::mvfst_codec mvfst::mvfst_looper mvfst::mvfst_buf_accessor mvfst::mvfst_bufutil mvfst::mvfst_socketutil mvfst::mvfst_cc_algo mvfst::mvfst_fizz_client mvfst::mvfst_fizz_handshake mvfst::mvfst_flowcontrol mvfst::mvfst_handshake mvfst::mvfst_happyeyeballs mvfst::mvfst_qlogger mvfst::mvfst_loss mvfst::mvfst_server mvfst::mvfst_state_machine mvfst::mvfst_state_ack_handler mvfst::mvfst_state_stream_functions mvfst::mvfst_state_pacing_functions mvfst::mvfst_state_functions mvfst::mvfst_state_simple_frame_functions mvfst::mvfst_state_qpr_functions mvfst::mvfst_state_stream mvfst::mvfst_d6d_probe_raiser)
...
set_target_properties(mvfst::mvfst_constants PROPERTIES
  ...
  INTERFACE_LINK_LIBRARIES "Folly::folly;/usr/lib/x86_64-linux-gnu/libboost_context.so;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so;/usr/lib/x86_64-linux-gnu/libboost_program_options.so;/usr/lib/x86_64-linux-gnu/libboost_regex.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_thread.so;-lpthread;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so"
)
...
set_target_properties(mvfst::mvfst_client PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/"
  INTERFACE_LINK_LIBRARIES "Folly::folly;mvfst::mvfst_flowcontrol;mvfst::mvfst_happyeyeballs;mvfst::mvfst_loss;mvfst::mvfst_qlogger;mvfst::mvfst_socketutil;mvfst::mvfst_state_ack_handler;mvfst::mvfst_state_pacing_functions;mvfst::mvfst_transport"
)
...
set_target_properties(mvfst::mvfst_codec_types PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/"
  INTERFACE_LINK_LIBRARIES "Folly::folly;mvfst::mvfst_bufutil;mvfst::mvfst_constants;mvfst::mvfst_exception;/usr/lib/x86_64-linux-gnu/libboost_context.so;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so;/usr/lib/x86_64-linux-gnu/libboost_program_options.so;/usr/lib/x86_64-linux-gnu/libboost_regex.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_thread.so;\$<LINK_ONLY:-lpthread>;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so"
)
...
set_target_properties(mvfst::mvfst_server PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/"
  INTERFACE_LINK_LIBRARIES "Folly::folly;fizz::fizz;mvfst::mvfst_buf_accessor;mvfst::mvfst_constants;mvfst::mvfst_codec;mvfst::mvfst_codec_types;mvfst::mvfst_fizz_handshake;mvfst::mvfst_qlogger;mvfst::mvfst_state_ack_handler;mvfst::mvfst_transport"
)
...
set_target_properties(mvfst::mvfst_state_machine PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/"
  INTERFACE_LINK_LIBRARIES "Folly::folly;mvfst::mvfst_bufutil;mvfst::mvfst_constants;mvfst::mvfst_codec;mvfst::mvfst_codec_types;mvfst::mvfst_handshake;mvfst::mvfst_d6d_probe_raiser"
)
...
set_target_properties(mvfst::mvfst_state_simple_frame_functions PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/"
  INTERFACE_LINK_LIBRARIES "Folly::folly;mvfst::mvfst_state_qpr_functions;mvfst::mvfst_state_functions;mvfst::mvfst_state_machine;mvfst::mvfst_codec_types"
)

# Create imported target mvfst::mvfst_state_qpr_functions
add_library(mvfst::mvfst_state_qpr_functions STATIC IMPORTED)

set_target_properties(mvfst::mvfst_state_qpr_functions PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/"
  INTERFACE_LINK_LIBRARIES "Folly::folly;mvfst::mvfst_bufutil;mvfst::mvfst_state_machine;mvfst::mvfst_state_stream_functions;mvfst::mvfst_codec_types;mvfst::mvfst_flowcontrol"
)
